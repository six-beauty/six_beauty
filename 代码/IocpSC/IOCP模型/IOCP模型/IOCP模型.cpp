...
{  
	...
	*	LPDWORD lpNumberOfBytes,     // 从I/O操作中读出的字节数
	*	PULONG_PTR lpCompletionKey,  // 这次I/O操作的文件的HANDLE
	*	LPOVERLAPPED *lpOverlapped,  // 接收到的overlapped结构体的地址
	...
	*/
	while(true){  
		...
		PerIoData = (LPPER_IO_DATA)CONTAINING_RECORD(IpOverlapped, PER_IO_DATA, overlapped);		//通过IpOverlapped的地址获得其结构体PER_IO_DATA的地址
